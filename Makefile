...
SOURCES = \
	__init__.py \
	dbp_simulator.py dbp_simulator_dockwidget.py

PLUGINNAME = dbp_simulator

PY_FILES = \
	__init__.py \
	dbp_simulator.py dbp_simulator_dockwidget.py

UI_FILES = dbp_simulator_dockwidget_base.ui
...
QGISDIR=C:\Users\mkiri\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
